...
const DataTableWithButtons = () => {
  ...
  const CustomPagination = () => (
    <ReactPaginate
      ...
      pageCount={searchValue.length ? filteredData.length / 50 : data.length / 50 || 1}
      breakLabel='...'
  ...
  return (
    <Fragment>
      ...
      <div>
          <CardTitle className='mb-75' tag='h2'>Attacks Details</CardTitle>
          <CardSubtitle className='text-muted'>Organization Attack Thread Dsetails</CardSubtitle>
          </div>
