              ...
              <div className='d-flex justify-content-start'>
                ...
                <div className='d-flex flex-column ml-1'>
                  ...
                  <div className='d-flex flex-wrap align-items-center'>
                    <Button.Ripple tag={Link} to={`/administration/userconfig/user/edit/${selectedUser.id}`} color='primary'>
                      Edit
                    </Button.Ripple>
          ...
          <Col xl='6' lg='12' className='mt-2 mt-xl-0'>
            <div className='user-info-wrapper'>
              ...
              <div className='d-flex flex-wrap align-items-center'>
                ...
                <CardText className='mb-0'>{selectedUser !== null ? selectedUser.email : 'jray.sarkar@whizhack.com'}</CardText>
              </div>
            </div>
          </Col>
        </Row>
