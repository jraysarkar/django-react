          ...
          <div className='email-app-menu'>
            ...
            <PerfectScrollbar className='sidebar-menu-list' options={{ wheelPropagation: false }}>
              <ListGroup tag='div' className='list-group-messages'>
                ...
                {/*<ListGroupItem
                  tag={Link}
                  to='/administration/userlog/sent'
                ...
                {/*<ListGroupItem
                  tag={Link}
                  to='/administration/userlog/draft'
                ...
                <ListGroupItem
                  tag={Link}
                  to='/administration/userlog/starred'
                ...
                <ListGroupItem
                  tag={Link}
                  to='/administration/userlog/spam'
                ...
                <ListGroupItem
                  tag={Link}
                  to='/administration/userlog/trash'
              ...
              <ListGroup tag='div' className='list-group-labels'>
                ...
                <ListGroupItem
                  tag={Link}
                  to='/administration/userlog/label/important'
                ...
                <ListGroupItem
                  tag={Link}
                  to='/administration/userlog/label/private'
