        ...
        return (
          <Card className='ecommerce-card' key={item.name}>
            <div className='item-img text-center mx-auto'>
              <Link to={`/administration/ecommerce/product-detail/${item.slug}`}>
            ...
            <CardBody>
              ...
              <h6 className='item-name'>
                <Link className='text-body' to={`/administration/ecommerce/product-detail/${item.slug}`}>
                  {item.name}
                </Link>
            ...
            <div className='item-options text-center'>
              ...
              >
                ...
                <span>{item.isInCart ? 'Add Details' : 'Add Details'}</span>
              </Button>
            </div>
          </Card>
        )
