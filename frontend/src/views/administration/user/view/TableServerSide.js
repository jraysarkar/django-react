...
import { Card, CardHeader, CardTitle, Input, Label, Row, Col, CardSubtitle, Button } from 'reactstrap'
  ...
  return (
    <Fragment>
      ...
      <div>
          ...
          <Button.Ripple color='primary' className= 'ml-1' onClick={() => toggleModal()}>
           Export
          </Button.Ripple>
