...
import { DollarSign, TrendingUp, User, Check, FileMinus, Flag, Phone } from 'react-feather'
...
const UserInfoCard = ({ selectedUser }) => {
  ...
  return (
    <Card>
      <CardBody>
        <Row>
          <Col xl='6' lg='10' className='d-flex flex-column justify-content-between border-container-lg'>
              ...
              <div className='d-flex justify-content-start'>
                ...
                <div className='d-flex flex-column ml-1'>
                  ...
                  <div className='d-flex flex-wrap align-items-center'>
                    <Button.Ripple tag={Link} to={`/administration/user/edit/${selectedUser.id}`} color='primary'>
                      Edit
                    </Button.Ripple>
            ...
            <div className='d-flex align-items-center user-total-numbers'>
              <div className='d-flex align-items-center mr-2'>
                <div className='color-box bg-light-primary'>
                  <FileMinus className='text-primary' />
                </div>
                <div classname='mb-0'>
                <div className='ml-1'>
              ...
              <div className='d-flex align-items-center'>
                <div className='color-box bg-light-success'>
                  <FileMinus className='text-success' />
                </div>
                <div className='ml-1'>
            ...
            <div className='user-info-wrapper'>
              <div className='d-flex flex-wrap align-items-center my-100'>
                ...
                <CardText className='mb-0'>
                  {selectedUser !== null ? selectedUser.OrganizationPhoneNumber : 'eleanor.aguilar'}
                </CardText>
              </div>
