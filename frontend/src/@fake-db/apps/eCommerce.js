...
const data = {
  ...
  products: [
...

    {
      ...
      image: require('@src/assets/images/pages/eCommerce/images.png').default,
...

    {
      ...
      image: require('@src/assets/images/pages/eCommerce/images1.jpg').default,
...

    {
      ...
      image: require('@src/assets/images/pages/eCommerce/download.jpg').default,


      description: `
      For Developer’s Access:
Go to https://developer.amazonservices.in
Log into your Amazon seller account.
The heading Third-Party Developer and Apps can be found the user permissions screen. This is where the you have to click on Visit Manage your Apps.
Make sure that you enter the credentials as following:
Developer’s Name: KartRocket
Developer Account Number: 1469-7463-9584
Click on “Next”
Accept the “Terms & conditions” and click on “Next”.
Copy the “MERCHANT ID” & paste it here in respective field.
Copy the "MWS Authorisation Token" and paste it in respective field
Click here to know more.
Note: Shiprocket does not pull "EASYSHIP" orders as they are fulfilled by Amazon Transport Services (ATS). They can be processed and shipped on Amazon Seller central only.`
